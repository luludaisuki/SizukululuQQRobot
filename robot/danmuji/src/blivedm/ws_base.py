...
class WebSocketClientBase:
    ...
    def add_handler(self, handler: Optional['handlers.HandlerInterface']):
    ...
    def _handle_command(self, command: dict):
        ...
        try:
            ...
            asyncio.create_task(self._handler.handle(self, command,None))
            # self._handler.handle(self, command,None)
        except Exception as e:
